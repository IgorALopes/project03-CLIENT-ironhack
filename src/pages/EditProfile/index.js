        ...
        <div className={style.main}>
            ...
            <Formik
                ...
                <Form>
                    ...
                    <label>Nome</label> 
                    <Field name="name" type="text" placeholder={userBefore.name} />

                    <label>E-mail</label>
                    <Field name="email" type="email" placeholder={userBefore.email}  />
            ...
            <button className={style.deleteBtn} onClick={handleToast}>Delete Profile</button>
            </div>
        </div>
        </>
    );
